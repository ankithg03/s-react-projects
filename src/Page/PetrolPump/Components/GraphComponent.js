    ...
    return (<>
        <table className="mx-auto" border="1">
            <tr>
                <td></td>
                <td>
                    <div className='grid grid-cols-2 nodes text-center' style={{background:"#FBF0B2"}}>
            ...
            <tr>
                <td>
                    <div className='grid grid-cols-2 nodes text-center' style={{background:"#D8B4F8"}}>
                ...
                <td></td>
                <td>
                    <div className='grid grid-cols-2 nodes text-center'>
