        ...
        <Router>
            <div>
                ...
                {/* <div className=" mx-5 sm:mx-10 my-5">
                    <Link className="link" to="/">RProjects</Link>                         
                </div> */}
                    ...
                    <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
                        ...
                        <div className={navVis?"lg:flex flex-grow items-center":"lg:flex flex-grow items-center hidden"} id="example-collapse-navbar">
                            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
                                ...
                                <li className="nav-item">
                                    <a className="px-3 py-2 flex items-center text-xs uppercase font-bold leading-snug text-white hover:opacity-75" href="#pablo" onClick={handleCopy}>
